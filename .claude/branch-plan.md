...
## ブランチ
- ブランチ名: feature/home-tab
- 作成日: 2026-05-02
- Issue: #

## 目的
ホームタブ (H1) の実装。直近リリースのサマリー・受付スケジュール・チケット情報・申込み状況ヒートマップを表示する。
...
### 1. 設計
- [x] Plan モードで設計を行い、ユーザーと合意した
- [x] `/plan-review` で Codex にレビューしてもらい、指摘を反映した
- [x] 上の「設計・方針」セクションに合意内容を転記した
